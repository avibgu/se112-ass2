...
public class JobsController {
	...
	public JobsController() {
		...
		this.setConnectedUsers(new HashSet<User>());
	}
	...
	public int addCompany(Company newComp) {
		getCompanies().add(newComp);
		return newComp.getId();
	}
	...
	public boolean login(String username, String password){
		...
		if (comp == null)
			...
			getConnectedUsers().add(new User(username));
			return true;
		}
		else
			return false;
	...
	public void logout(String username){
		...
		Set<User> users = getConnectedUsers();
	...
	public Integer publishMessage(String body,String location,String role,String field, String user){
		...
		comp.notifyObservers(comp.getUsername() +
				" published a new message (id " + msg.getId() + "):\n" +
				msg.getBody() + "\n");
	...
	public boolean editAd(String user, String pass, int id,
			String newBody, String newLocation, String newRole, String newField, String newstatus) {
		...
		if (null != msg){
			...
			msg.setBody(newBody);
			msg.setLocation(newLocation);
			msg.setRole(newRole);
			msg.setField(newField);
			msg.setStatus(newstatus);
			
			// notify about new message
			comp.notifyObservers(comp.getUsername() +
					" changed message " + msg.getId() + ":\n" +
					msg.getBody() + "\n");
	...
	public void registerToUpdates(User user, Company comp){
		comp.addObserver(user);
	}
	
	public void unregisterFromUpdates(User user, Company comp){
		comp.deleteObserver(user);
	}
	...
	public void setConnectedUsers(Set<User> connectedUsers) {
