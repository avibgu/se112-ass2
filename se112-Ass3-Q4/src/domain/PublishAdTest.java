...
public class PublishAdTest extends DrushimTests {
	...
	public void testUpdateNumAd() {
		...
		this.bridge.addNewAd(user99, pass99, "DBA team leader","Minimum 5 years experience as Oracle DBA.","Tel-aviv","Software");
		...
		this.bridge.addNewAd(user0, pass0, "DBA team leader","Minimum 5 years experience as Oracle DBA.","Tel-aviv","Software");
	...
	public void testPublishAd(){
		...
		String pass99="0inside";
		String id;
		id=this.bridge.addNewAd(user99, pass99, "DBA team leader","Minimum 5 years experience as Oracle DBA.","Tel-aviv","Software");
